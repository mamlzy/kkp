...
export function Dashboard() {
  ...
  const pieData = summary?.status_distribution
    ? [
        { name: "Berprestasi", value: summary.status_distribution.berprestasi || 0 },
        { name: "Tidak Berprestasi", value: summary.status_distribution.tidak_berprestasi || 0 },
      ]
    : [];
    ...
    <div className="space-y-8">
      ...
      <div className="animate-fade-in">
        ...
        <p className="text-muted-foreground mt-1">
          Ringkasan sistem prediksi siswa berprestasi menggunakan metode CART
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="animate-fade-in stagger-2 border-none shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">Dataset tersimpan</p>
          </CardContent>
        </Card>
        ...
        <Card className="animate-fade-in stagger-3 border-none shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {summaryLoading ? "..." : formatAccuracy(summary?.latest_model_accuracy)}
            </div>
            <p className="text-xs text-muted-foreground mt-1">Tingkat akurasi</p>
          </CardContent>
        </Card>
        ...
        <Card className="animate-fade-in stagger-4 border-none shadow-lg hover:shadow-xl transition-shadow">
          ...
          <CardContent>
            <div className="text-3xl font-bold">
              {summaryLoading ? "..." : summary?.prediction_stats?.total_predictions || 0}
            </div>
            <p className="text-xs text-muted-foreground mt-1">Prediksi dilakukan</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="animate-fade-in border-none shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Perbandingan hasil prediksi siswa berprestasi dan tidak berprestasi
            </CardDescription>
          </CardHeader>
          <CardContent>
            {hasPieData ? (
      ...
      <Card className="animate-fade-in border-none shadow-lg bg-gradient-to-br from-primary/5 to-cyan-500/5">
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <p>
            Sistem ini menggunakan metode <strong>Classification and Regression Tree (CART)</strong> untuk 
            memprediksi status prestasi siswa berdasarkan nilai mata pelajaran dan kehadiran.
          </p>
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg bg-white/50 p-4">
              <h4 className="font-semibold text-foreground mb-2">Fitur Prediksi</h4>
            ...
            <div className="rounded-lg bg-white/50 p-4">
              <h4 className="font-semibold text-foreground mb-2">Cara Penggunaan</h4>
              <ul className="space-y-1 text-xs">
